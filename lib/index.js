...
var es6forOf= require('es6-for-of');
 ...
 *   destructuring - Compile ES6 destructuring.
...
function transform(ast, options) {
  ...
  if (options.computedPropertyKeys !== false) {
    ast = es6computedPropertyKeys.transform(ast);
  }
  ...
  if (options.arrayComprehensions === true) {
  ...
  if (options.forOf !== false) {
    ast = es6forOf.transform(ast);
  }
